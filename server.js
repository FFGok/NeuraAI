...
function modelProfili(tip){
  ...
  if(t === "hizli"){
    return {
      ad:"Hızlı",
      model: process.env.OPENROUTER_FAST_MODEL || "openai/gpt-5.6-terra",
      maxKisa:650,
      maxUzun:1600,
  ...
  if(t === "yaratici"){
    return {
      ad:"Yaratıcı",
      model: process.env.OPENROUTER_CREATIVE_MODEL || "openai/gpt-5.6-terra",
      maxKisa:1200,
      maxUzun:2600,
  ...
  if(t === "kod"){
    return {
      ad:"Kod",
      model: process.env.OPENROUTER_CODE_MODEL || "openai/gpt-5.6-terra",
      maxKisa:1800,
      maxUzun:4200,
  ...
  return {
    ad:"Akıllı",
    model: process.env.OPENROUTER_SMART_MODEL || "openai/gpt-5.6-terra",
    maxKisa:1200,
    maxUzun:3200,
